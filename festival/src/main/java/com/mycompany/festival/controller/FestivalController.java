...
public class FestivalController {    
    ...
    public ResponseEntity<List<FestivalO>> getAllFestivals() {
        // Επιστρέφουμε μια κενή λίστα FestivalO.
        // Αυτό δεν απαιτεί αλλαγές στο FestivalService ή άλλα DTOs.
        return ResponseEntity.ok(new ArrayList<>()); 
//        List<FestivalO> festivals = festivalService.findAllFestivals();
//        return ResponseEntity.ok(festivals);
    ...
    // Πρόσθεσε και τα PUT και DELETE αν τα χρειάζεσαι
    // @PutMapping("/{id}")
    // @PreAuthorize("hasRole('ORGANIZER')")
    // public ResponseEntity<FestivalO> updateFestival(@PathVariable Long id, @RequestBody @Valid FestivalO festivalO) {
    //     // ... logic ...
    // }
